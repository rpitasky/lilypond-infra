...
def create_staff_group(apps, schema_editor):
    ...
    book_ct = ContentType.objects.get(app_label="file_upload", model="book")
    transcription_ct = ContentType.objects.get(
        app_label="file_upload", model="transcription"
    )
    revision_ct = ContentType.objects.get(app_label="file_upload", model="revision")
